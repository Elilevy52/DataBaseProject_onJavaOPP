...
public class MainMenuController implements MainEventListener, MainUiListener {
	...
	public void addOpenQuestion(String question, String answer) throws SQLException, ClassNotFoundException {
	...
	@Override
	public void addMultilpeChoiceQuestion(MultilpeChoiceQuestion question) throws ClassNotFoundException, SQLException {
	...
	@Override
	public void addMultipleChoiceQuestionAnswer(MultilpeChoiceQuestion quest ,String choiceAnswer, boolean isTrue) throws ClassNotFoundException, SQLException {
	...
	@Override
	public void importPreMade() throws SQLException, ClassNotFoundException {
